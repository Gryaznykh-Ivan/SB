...
import { Fulfillment, FulfillmentStatus, InvoiceStatus, Offer, OfferStatus, OrderStatus, PaymentStatus, Return, ReturnStatus, Invoice, InvoiceType, InvoiceMethod, Prisma } from '@prisma/client';
...
export class OrderService {
    ...
    async getOrdersBySearch(data: SearchOrderDto) {
        ...
        //         },
        //         {
        //             id: (data.q && isNaN(+data.q) === false) ? Number(data.q) : undefined,
        //         }
        //     ],
    ...
    async getFulfillmentById(fulfillmentId: number) {
    ...
    async updateFulfillment(orderId: number, fulfillmentId: number, data: UpdateFulfillmentDto, self: IUser) {
    ...
    async removeFulfillment(orderId: number, fulfillmentId: number, self: IUser) {
    ...
    async updateReturn(orderId: number, returnId: number, data: UpdateReturnDto, self: IUser) {
        // const orderReturn = await this.prisma.return.findUnique({
        //     where: {
        //         id: returnId
        //     },
    ...
    async removeReturn(orderId: number, returnId: number, self: IUser) {
        // const orderReturn = await this.prisma.return.findUnique({
        //     where: {
        //         id: returnId
        //     },
