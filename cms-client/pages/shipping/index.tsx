...
import { useCreateDeliveryProfileMutation, useLazyGetDeliveryProfileBySearchQuery } from '@/services/shippingService'
...
function Index() {
    ...
    const [getDeliveryProfileBySearch, { isError, isFetching, data, error }] = useLazyGetDeliveryProfileBySearchQuery();
    ...
    useEffect(() => {
        getDeliveryProfileBySearch(query)
    }, [query])
