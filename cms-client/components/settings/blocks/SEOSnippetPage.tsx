...
export default function SEOSnippetPage() {
    const { data, isLoading } = useGetVariablesByGroupQuery({ group: "SEO_SNIPPET_PAGE" })
    ...
    return (
        <div className="rounded-md bg-white shadow-sm">
            <h2 className="font-semibold p-5 border-b-[1px]">SEO шаблон страницы</h2>
            <div className="space-y-4 p-5">
                <div className="flex flex-col">
                    ...
                    <div className="text-gray-400 text-sm mt-1">Пример: [title] | EXAMPLE</div>
                </div>
                <div className="flex flex-col">
                    <div className="flex justify-between mb-1">
                    ...
                    <div className="mt-1 text-sm text-gray-400">
                        <div className="">Пример: [title]. Быстрая доставка в EXAMPLE</div>
