                            ...
                            <div className="px-5 py-2">
                                ...
                                <div className="pb-2 space-y-2">
                                    {state.newOptionValues.map((value, i) =>
                                        <div key={i} className="flex items-center justify-between bg-white">
                                            ...
                                            {state.newOptionValues.length - 1 !== i &&
                                                <button className={`ml-2 p-2 rounded-md hover:bg-gray-50`} onClick={() => onRemoveNewOptionValue(i)}>
                                    ...
                                    {state.newOptionValues.length > 1 &&
                                        <div className="flex ">
                                            <button className="flex-1 text-sm py-2 px-3 border-[1px] border-gray-300 hover:bg-gray-50 rounded-md font-medium" onClick={onOptionCreate}>Создать опцию</button>
                                        </div>
                                    }
                                </div>
                            </div>
