    ...
    return (
        <div className="">
            <div className="flex justify-between px-3 pt-4">
                ...
                <button className="flex items-center text-sm font-medium p-2 hover:bg-gray-50 rounded-md" onClick={() => onRemoveDeliveryZone(id)}>
            ...
            <div className="mt-4 px-5 pb-5">
                ...
                <div className="space-y-2 mt-2">
                    {state.values.map(option =>
                        <div key={option.id} className="flex bg-white">
                            ...
                            <button className="ml-1 p-2 rounded-md hover:bg-gray-50" onClick={() => onRemoveOptionValue(option.id)}>
                    ...
                    <div className="flex bg-white">
                        ...
                        <button className="ml-1 p-2 rounded-md hover:bg-gray-50" onClick={onAddOptionValue}>
                ...
                {state.mustBeSaved &&
                    <div className="flex justify-between">
                        <button className="w-full text-sm mt-2 py-2 px-3 border-[1px] border-gray-300 hover:bg-gray-50 rounded-md font-medium" onClick={onSave}>Готово</button>
                    </div>
                }
            </div>
        </div>
