...
export default function SideBar({ isMenuFolded, onClose }: IProps) {

    return (
        <div className={`space-y-1 w-full p-2 text-sm ${isMenuFolded ? "md:w-16" : "md:w-64"}`} onClick={onClose}>
            <NavLink href="/" className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive ? "stroke-green-700 text-green-700 bg-gray-100" : ""}`}>
                ...
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Главная</span>
            </NavLink>
            <NavLink href="/orders" className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive && "stroke-green-700 text-green-700 bg-gray-100"}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Заказы</span>
            </NavLink>
            <NavLink href="/products" className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive && "stroke-green-700 text-green-700 bg-gray-100"}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M16 11V7C16 5.93913 15.5786 4.92172 14.8284 4.17157C14.0783 3.42143 13.0609 3 12 3C10.9391 3 9.92172 3.42143 9.17157 4.17157C8.42143 4.92172 8 5.93913 8 7V11M5 9H19L20 21H4L5 9Z" stroke="inherit" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Товары</span>
            </NavLink>
            <NavLink href="/collections" className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive && "stroke-green-700 text-green-700 bg-gray-100"}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Коллекции</span>
            </NavLink>
            <NavLink href="/pages" className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive && "stroke-green-700 text-green-700 bg-gray-100"}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M19 20H5C4.46957 20 3.96086 19.7893 3.58579 19.4142C3.21071 19.0391 3 18.5304 3 18V6C3 5.46957 3.21071 4.96086 3.58579 4.58579C3.96086 4.21071 4.46957 4 5 4H15C15.5304 4 16.0391 4.21071 16.4142 4.58579C16.7893 4.96086 17 5.46957 17 6V7M19 20C18.4696 20 17.9609 19.7893 17.5858 19.4142C17.2107 19.0391 17 18.5304 17 18V7M19 20C19.5304 20 20.0391 19.7893 20.4142 19.4142C20.7893 19.0391 21 18.5304 21 18V9C21 8.46957 20.7893 7.96086 20.4142 7.58579C20.0391 7.21071 19.5304 7 19 7H17M13 4H9M7 16H13M7 8H13V12H7V8Z" stroke="inherit" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Страницы</span>
            </NavLink>
            <NavLink href="/users" className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive && "stroke-green-700 text-green-700 bg-gray-100"}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Пользователи</span>
            </NavLink>
            <NavLink href="/offers" className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive && "stroke-green-700 text-green-700 bg-gray-100"}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Складское наличие</span>
            </NavLink>
            <NavLink href="/shipping" className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive && "stroke-green-700 text-green-700 bg-gray-100"}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Доставка</span>
            </NavLink>
            <NavLink href={process.env.NODE_ENV === 'production' ? process.env.NEXT_PUBLIC_PARSER_URL_PRODUCTION as string : process.env.NEXT_PUBLIC_PARSER_URL_DEVELOPMENT as string} className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive && "stroke-green-700 text-green-700 bg-gray-100"}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Парсер</span>
            </NavLink>
            <NavLink href="/settings" className={({ isActive }) => `flex items-center font-semibold px-3 py-2 hover:bg-gray-50 rounded-md stroke-black ${isActive && "stroke-green-700 text-green-700 bg-gray-100"}`}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className={`ml-2 ${isMenuFolded && "hidden"}`}>Настройки</span>
            </NavLink>
        </div>
